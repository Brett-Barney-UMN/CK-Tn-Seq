...
## This script finds and reports the position of all nonpermissive sites in a genome
## input: python3 find_nonpermissive_TA_sites.py argv[1] > output_file.txt
## argv[1] is the genome fasta sequence of the organism
## The output file has 2 columns: 1) nonpermissive_seq; 2) 1-based index of the T in TA on the Fwd (+) strand
